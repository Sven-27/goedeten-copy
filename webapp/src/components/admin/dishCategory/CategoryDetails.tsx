...
export default observer(function CategoryDetails() {
    ...
    const {btnCancel, handleChangeForm,
      handleCancel, handleCreate,handleSave} = dishCategoryStore 


    const {register, handleSubmit,  formState: { errors } } = useForm<IDishCategory>({
      mode:"onSubmit",
      })
      const onSubmit: SubmitHandler<IDishCategory> = data => data;
      ...
      >
        ...
        >
          ...
          {...register("name",{ 
            ...
            value={dishCategoryStore.dataRow.name}
            placeholder=" naam..."
            variant="outlined"
            size = "small"
        ...
        >
          ...
          >
            ...
            <Button
              ...
              onClick={()=>handleSave(dishCategoryStore.dataRow)}
            >
                Opslaan
                   </Button>
          </div>
